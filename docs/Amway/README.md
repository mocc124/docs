...
- [Vue cli|Vue 开发标准脚手架，基于 webpack，使用 Vuex 管理状态](https://cli.vuejs.org/zh/)
- [create-vue|Vue 开发新脚手架，基于 vite，使用 Pinia 管理状态](https://github.com/vuejs/create-vue#)
- [webpack|常用打包构建工具](https://www.webpackjs.com/)
- [Vite|Vue 下一代构建工具](https://vitejs.cn/)
- [Vuex|vue 集中式存储管理库](https://vuex.vuejs.org/zh/guide/)
- [Pinia|Vue3 下一代状态管理库](https://pinia.web3doc.top/)
- [Nuxt 3|基于 Vue3 构建你的混合应用](https://www.nuxtjs.org.cn/)
- [figma|产品原型设计](https://www.figma.com/)
- [proto|移动端产品原型设计](https://proto.io/)
- [uizard|手绘线稿转原型图](https://uizard.io/)
